...
const WhatsAppWidget: React.FC = () => {
    return (
        <a 
            href="https://wa.link/cdrsuc" 
            target="_blank" 
            rel="noopener noreferrer" 
            aria-label="Contact us on WhatsApp" 
            className="fixed bottom-6 right-6 z-[90] bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 hover:scale-110 transform transition-all duration-300 ease-in-out"
        >
